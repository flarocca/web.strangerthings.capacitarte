...
namespace Capacitarte.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            var usuario = db.Usuarios.Include(i => i.Empleado).Include(i => i.Roles.Select(c => c.Rol)).SingleOrDefault(x => x.Username == model.Usuario);
            if (usuario == null || usuario.Password.Trim() != model.Password.Trim())
            {
        ...
        //
        // POST: /Account/SelectRol
        [HttpPost]
        public ActionResult SelectRol(SelectRolViewModel model, string returnUrl)
        {
            if (!ModelState.IsValid)
                return View(model);
